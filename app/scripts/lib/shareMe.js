...
(function($) {
  ...
  ShareMe.initialize = function(sharingData) {
    ...
    $buttonsFacebook.on('click', function(e) {
      e.preventDefault();
      ShareMe.openFacebook(sharingData.shareTitle,
        sharingData.captionFacebook,
        sharingData.descFacebook,
        sharingData.shareUrl,
        sharingData.sharePicture,
        sharingData.facebookAppId,
        sharingData.faceBookCallBack);
    });
